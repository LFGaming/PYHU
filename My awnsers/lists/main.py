...
# > Bereken ook het gemiddelde van deze lijst

average = sum(onze_lijst) / len(onze_lijst)
...
# > Zoek het grooste nummer deze keer in de lijst door de lijst te sorteren en naar het laatste element te kijken. Vergelijk dit met het grootste nummer dat je eerst vond.
...
# > Vraag een gebruiker om zijn gebruikersnummer (dat is de index in de lijst, dus gebruiker 0 heeft als wachtwoord 'wachtwoord')
